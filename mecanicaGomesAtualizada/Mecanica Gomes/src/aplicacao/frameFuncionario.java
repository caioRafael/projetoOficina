...
public class frameFuncionario extends javax.swing.JFrame {
    ...
    public void popularTabela(){
        ...
        List<Funcionario> lista =  funcionario.getAll();
    ...
    public void popularTabelaBusca(String desc) {
        FuncionarioDAO funcionario = new FuncionarioDAO();
        List<Funcionario> lista =  funcionario.getAllNome(desc);
    ...
    private void initComponents() {
        ...
        campoSalario.setFont(new java.awt.Font("Georgia", 0, 12)); // NOI18N

        jLabel10.setFont(new java.awt.Font("Georgia", 0, 12)); // NOI18N
        jLabel10.setText("TELEFONE");

        campoTelefone.setFont(new java.awt.Font("Georgia", 0, 12)); // NOI18N
        ...
        campoEndereco.setFont(new java.awt.Font("Georgia", 0, 12)); // NOI18N
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(campoEndereco, javax.swing.GroupLayout.PREFERRED_SIZE, 444, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(campoSalario, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {campoEndereco, campoNome, campoSalario, campoSenha, campoTelefone});
        ...
        tabelaPessoa.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nome", "Endereco", "Telefone", "Salario", "Senha"
            }
        ) {
            boolean[] canEdit = new boolean [] {
    ...
    private void botaoAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoAtualizarActionPerformed
     ...
     if(tabelaPessoa.getSelectedRow() != -1){
        ...
        p.setSalario(salario);
        p.setSenha(senha);
        p.setId_funcionario((Integer) tabelaPessoa.getValueAt(tabelaPessoa.getSelectedRow(), 0));
        
        FuncionarioDAO pessoa= new FuncionarioDAO();
        pessoa.update(p);
    ...
    private void tabelaPessoaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaPessoaMouseClicked
        ...
        campoEndereco.setText(tabelaPessoa.getValueAt(tabelaPessoa.getSelectedRow(), 2).toString());  
        campoTelefone.setText(tabelaPessoa.getValueAt(tabelaPessoa.getSelectedRow(), 3).toString());
        campoSalario.setText(tabelaPessoa.getValueAt(tabelaPessoa.getSelectedRow(), 4).toString());
        campoSenha.setText(tabelaPessoa.getValueAt(tabelaPessoa.getSelectedRow(), 5).toString());
