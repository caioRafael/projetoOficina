...
public class frameCliente extends javax.swing.JFrame {
    ...
    public void popularTabela(){
        ...
        List<Cliente> lista =  cliente.getAll();
    ...
    public void popularTabelaBusca(String desc) {
        ClienteDAO cliente = new ClienteDAO();
        List<Cliente> lista =  cliente.getAllNome(desc);
    ...
    private void initComponents() {
        ...
        campoEmail.setFont(new java.awt.Font("Georgia", 0, 12)); // NOI18N
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(campoTelefone, javax.swing.GroupLayout.PREFERRED_SIZE, 233, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {campoEmail, campoEndereco, campoNome, campoSenha, campoTelefone});
        ...
        tabelaPessoa.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nome", "Endereco", "Telefone", "Email", "Senha"
            }
        ) {
            boolean[] canEdit = new boolean [] {
    ...
    private void botaoCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoCadastrarActionPerformed
        ...
        ClienteDAO funcionario= new ClienteDAO();
    ...
    private void botaoAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoAtualizarActionPerformed
     ...
     if(tabelaPessoa.getSelectedRow() != -1){
        ...
        p.setEmail(email);
        p.setSenha(senha);
        p.setId_cliente((Integer) tabelaPessoa.getValueAt(tabelaPessoa.getSelectedRow(), 0));
    ...
    private void tabelaPessoaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaPessoaMouseClicked
        ...
        campoEmail.setText(tabelaPessoa.getValueAt(tabelaPessoa.getSelectedRow(), 4).toString());
